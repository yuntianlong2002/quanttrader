...
class PerformanceManager(object):
    ...
    def on_fill(self, fill_event):
        ...
        self._df_trades = pd.concat([self._df_trades, pd.DataFrame({'amount': [int(fill_event.fill_size)], 'price': [fill_event.fill_price], 'symbol': [fill_event.full_symbol]},index=[fill_event.fill_time])])
